...
# Ruta de instalación de DWSIM (ajústala según corresponda)
dwsimpath = "C:\\Users\\manue\\AppData\\Local\\DWSIM\\"
...
cnames = ["Oxygen", "Nitrogen","Argon"]

myflowsheet.AddCompound("Oxygen")
myflowsheet.AddCompound("Nitrogen")
myflowsheet.AddCompound("Argon")
...
feed.SetOverallComposition(Array[float]([0.21, 0.78, 0.01]))
feed.SetTemperature(100.0) # K
feed.SetPressure(10*101325.0) # Pa
